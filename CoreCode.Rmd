...
##### MAKE MATCH THE BLOODY THINGS
```{r}

df15Imm <- names(df12Imm)[1]  <- "Immigration"
df15Imm <- names(df12Imm)[2]  <- "Analyzing"
df15Imm <- names(df12Imm)[3]  <- "Designing"
df15Imm <- names(df12Imm)[4]  <- "Writing"
df15Imm <- names(df12Imm)[5]  <- "DevResistance"
df15Imm <- names(df12Imm)[6]  <- "PresentingSpecialist"
df15Imm <- names(df12Imm)[7]  <- "PresentingPublic"
df15Imm <- names(df12Imm)[8]  <- "ApplyingFunding"
df15Imm <- names(df12Imm)[9]  <- "SatisCareer"
df15Imm <- names(df12Imm)[10] <- "MngCompProj"
df15Imm <- names(df12Imm)[11] <- "DevBusinessPlan"
df15Imm <- names(df12Imm)[12] <- "MngPeople"
df15Imm <- names(df12Imm)[13] <- "MngLargeBudget"
df15Imm <- names(df12Imm)[14] <- "FeelProgPrepResearch"
df15Imm <- names(df12Imm)[15] <- "FeelProgPrepScience"
df15Imm <- names(df12Imm)[16] <- "Collecting1"
df15Imm <- names(df12Imm)[17] <- "Collecting"
...
####Immigration against Collecting Data 
...
groupedBarGenderCollectingImm <- ggplot(data = dfImm) + 
